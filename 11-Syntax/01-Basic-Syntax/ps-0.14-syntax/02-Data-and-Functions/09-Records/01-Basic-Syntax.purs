...
overwriteField_equalsOperator rec string = rec { label1 = string }
...
setField_recordUnderscore string = _ { label1 = string }                      {-

setField_recordUnderscore "bar" { label1: "foo" } == { label1: "bar" }        -}
...
setField_recordAndArgUnderscore = _ { label1 = _ }                            {-

setField_recordAndArgUnderscore { label1: "foo" } "bar" == { label1: "bar" }  -}
