...
module Games.RandomNumber.Run.Standard.Infrastructure.Halogen.Terminal (terminal) where
...
import Games.RandomNumber.Run.Standard.Infrastructure.Halogen.UserInput (Language, calcLikeInput)
